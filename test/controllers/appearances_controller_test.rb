...
class AppearancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create appearance" do
    assert_difference('Appearance.count') do
      post appearances_url, params: { appearance: { actor_id: @appearance.actor_id, movie_id: @appearance.movie_id } }
    end
  ...
  test "should update appearance" do
    patch appearance_url(@appearance), params: { appearance: { actor_id: @appearance.actor_id, movie_id: @appearance.movie_id } }
